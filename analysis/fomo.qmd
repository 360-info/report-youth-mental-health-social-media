...
fomo_plot <- fomo |>
    ...
    scale_color_manual(values = c("#38c99e", "#cf1d1d")) +
    ...
    labs(
        title = "DOES FEAR OF MISSING OUT INCREASE\nANXIETY IN TEENS?",
        subtitle = "Based on a study of 951 adolescents, **FoMO moderates the link** between social media use<br> and anxiety in adolescence. Those with <span style='color:#38c99e'>**lower levels of FoMO**</span> benefit from increased social<br> media usage, while those with <span style='color:#cf1d1d'>**higher levels of FoMO**</span> experience more anxiety",
